...
class Netbar extends Common
{
	...
	public function details()
	{
		...
		$netbar_data = Db::table('hn_netbar')->field('id,c_id,name,img,legal_person,phone,location,business_license,ip,extract,not_extract,lat,lng,addtime,status,examine_type')->where('id',$id)->find();
