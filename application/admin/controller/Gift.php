	...
	public function add()
	{
		if(Request::instance()->isPost())
		{
			...
			if($file){
				...
				if($url_data['code'] == 0){
					//成功
					$gift_data['img_url'] = 'http://uploadimg-1257183241.piccd.myqcloud.com/'.$key; //将此路径存入表单
				}
			}
	...
	public function edit()
	{
		...
		if(Request::instance()->isPost())
		{
			...
			if($file){
				...
				if($url_data['code'] == 0){
					//成功
					$gift_edit['img_url'] = 'http://uploadimg-1257183241.piccd.myqcloud.com/'.$key; //将此路径存入表单
				}
			}
